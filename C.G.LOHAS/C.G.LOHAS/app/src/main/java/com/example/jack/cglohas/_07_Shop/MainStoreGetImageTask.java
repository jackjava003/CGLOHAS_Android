...
class MainStoreGetImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "MianStoreGetImageTask";
    private final static String ACTION = "getMainStoreImage";
    private final WeakReference<ImageView> imageViewWeakReference;

    MainStoreGetImageTask(ImageView imageView) {
