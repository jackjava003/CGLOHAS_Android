...
public class register_bean {
	...
	private Timestamp createTime; // 加入會員日期
	...
	public register_bean(String account, String password, String name, String email, String cellphone,String sex) {
		super();
	...
	public register_bean(int memberId, int userID, String account, String password, String name, String email,
			String cellphone, String sex, Timestamp createTime, String birthdate1, int like_count,
	...
	public register_bean(int userID,String account, String name, String email, String cellphone,
			Timestamp createTime, int like_count, int dislike_count) {
		super();
		this.userID=userID;
		this.account = account;
		this.name = name;
	...
	public void setBirthdate1(String bd) {
		this.birthdate1 = bd;
	}
