...
class ShopGetImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "ShopGetImageTask";
    private final static String ACTION = "getImage";
    private final WeakReference<ImageView> imageViewWeakReference;

    ShopGetImageTask(ImageView imageView) {
    ...
    protected Bitmap doInBackground(Object... params) {
        ...
        int storeid = Integer.parseInt(params[3].toString());
